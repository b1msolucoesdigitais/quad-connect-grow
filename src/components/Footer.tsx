      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => window.open('https://api.whatsapp.com/send?phone=553138236644')}
              >
        ...
        <div className="border-t border-border mt-12 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © 2024 Quad Informática. Todos os direitos reservados. 
            Há mais de 10 anos trazendo tecnologia para o Vale do Aço.
          </p>
        </div>
      </div>
    </footer>
